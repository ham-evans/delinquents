...
import "./About.css";
import aboutLilly from '../images/aboutLilly.png'
    ...
    return (
        <div className="about" id="project">
            <div className="about__imgContainer">
                <img className="about__imgIndividual" src={aboutLilly} alt="Shark Example"/>
            </div>
            <div className="about__container"  >
                <h1>ABOUT CRYPTO DELinkUENTs</h1> 
                <p>Welcome to the Crypto DELinkUENTs, a collection of 6,666 unique tattooed degens living on the Ethereum blockchain looking for their next score.</p>
